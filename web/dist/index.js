...
const incidentWorkLogs_1 = require("./routes/incidentWorkLogs");
const incidentMaterials_1 = require("./routes/incidentMaterials");
...
app.use(`${API_PREFIX}/clients/:clientId/objects/:objectId/units`, objectUnits_1.objectUnitsRouter);
...
app.use(`${API_PREFIX}/asset-types`, assetTypes_1.assetTypesRouter);
